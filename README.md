...
===
The reason I created this file is because even though the idea of the program was simple,
my code was getting out of control and I was loosing track of which parts of the code were intended for testing
and which were part of the program. I have therefore decided to clearly write out the requirements in this file.
...
----------------------------------------------------------------------------------------------------------------
				...
				(taken from Neil Spiers' CSC1021 module on programming at Newcastle University (UK) ).
							...
							N.B. This piece of coursework was created for students learning Java,
									so there may be some parts that don't apply to c++
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
												II. Requirement outline

									This is my own analysis of what needs doing and how
								This is __NOT__ an official answer and may be incorrect
							It is here simply to help me understand how to approach this task
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
